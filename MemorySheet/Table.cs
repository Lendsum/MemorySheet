...
namespace Lendsum.MemorySheet
{
    ...
    public class Table
    {
        ...
        /// <summary>
        /// Gets the <see cref="Lendsum.MemorySheet.Column" /> with the specified name.
        /// </summary>
        /// <value>
        /// The <see cref="Lendsum.MemorySheet.Column" />.
        /// </value>
        ...
        /// <summary>
        /// Gets or sets the <see cref="System.Object"/> with the specified column.
        /// </summary>
        /// <value>
        ...
        public void AddUpdateCell(Cell value)
        {
            ...
            if (!this.columns.ContainsKey(column)) throw new ArgumentException("column doesnt exists");
            if (!this.cells.ContainsKey(index))
            {
